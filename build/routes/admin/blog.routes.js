...
router.route('/')
    ...
    .put((0, auth_1.default)(appConstant_1.USER_TYPE.ADMIN), fileUpload_1.default.any(), (0, validate_1.validate)(blog_validation_1.default.updateBlog), blog_controller_1.default.updateBlog)
